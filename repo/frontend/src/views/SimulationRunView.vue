...
.status-indicator.processing .dot { background: var(--status-running); animation: pulse 1s infinite; }
.status-indicator.completed .dot { background: var(--status-provisioning); }
