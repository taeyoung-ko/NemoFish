...
.switch-btn {
  ...
  cursor: pointer;
  transition: background var(--motion-base) var(--motion-easing), color var(--motion-base) var(--motion-easing);
}
...
.status-indicator.ready .dot { background: var(--status-running); }
